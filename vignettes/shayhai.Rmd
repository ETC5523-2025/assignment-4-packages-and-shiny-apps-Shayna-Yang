...
```{r fig.alt="Bar plot showing estimated annual HAIs by infection type in the German PPS sample"}
germany_summary |>
  ggplot(aes(x = infection_type, y = n_hai_est, fill = infection_type)) +
  geom_col() +
  ...
  labs(
    title = "Estimated annual HAIs by infection type (German PPS)",
    y = "Estimated HAIs")
```
