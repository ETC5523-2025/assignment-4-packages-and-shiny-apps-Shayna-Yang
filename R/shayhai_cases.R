#' Simulated case-level HAI burden data
#'
...
#'
#' @format A tibble-like data frame with ~5,000 rows and 9 columns.
#' @source Calibrated to published summary estimates (German PPS).
"shayhai_cases"
